...
// FALLBACK DATA: This prevents a crash if your constants file is missing
      ...
      <div className="pb-10 animate-in fade-in duration-500">
          ...
          <GlassCard className="p-6 border-l-4 border-l-tup-green">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1">{LibraryData.hoursWeekday}</p>
                <p className="text-xs text-gray-600 font-bold italic mt-1">Saturday: {LibraryData.hoursSaturday}</p>
              </div>
            </div>
          </GlassCard>
        </div>
        ...
        <section className="space-y-4">
          ...
          {LibraryData.sections.map((section, index) => (
            <GlassCard key={index} className="p-5 flex items-center gap-4 group hover:border-tup-green/20 transition-all">
              ...
              <p className="text-sm font-bold text-tup-navy">{section}</p>
            </GlassCard>
          ))}
        </section>
        ...
        <div className="mt-10 p-5 bg-tup-navy rounded-handbook text-white shadow-xl">
           ...
           <p className="text-[10px] text-white/60 leading-relaxed">
             The Library supports the instructional curricula and provides the research needs of the students.
           </p>
        </div>
      </div>
    </StudentLayout>
